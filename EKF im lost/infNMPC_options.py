class Options:
    ...
    def __init__(self):
        ...
        self.ekf_Q_process          = .001   # process noise covariance (Ca, Cb, Cc, Cm, T) 
        self.ekf_Q_disturbance      = 50     # process noise covariance (d_UA, d_k) -how fast should the disturbance variables be changing?
                                             # if you expect a lot of noise should be large
        self.ekf_R                  = 0.05    # measurement noise covariance (T) [K^2] -how much sensor noise on T? larger value means more noise
        self.ekf_R_Cc               = 0.05   # measurement noise covariance (Cc) [mol/L]^2 -how much sensor noise on Cc? larger value means more noise
        self.ekf_P0_scale           = .01    # initial error covariance = I * scale
